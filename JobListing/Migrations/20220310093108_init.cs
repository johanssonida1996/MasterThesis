...
namespace JobListing.Migrations
{
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "FavoriteCartItems",
                columns: table => new
                {
                    FavoriteCartItemId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    WorkerId = table.Column<int>(type: "int", nullable: true),
                    FavoriteCartId = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CompanyId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_FavoriteCartItems", x => x.FavoriteCartItemId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProjectTime = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FavoriteCartItems_CompanyId",
                table: "FavoriteCartItems",
                column: "CompanyId");

            migrationBuilder.CreateIndex(
                name: "IX_FavoriteCartItems_WorkerId",
                table: "FavoriteCartItems",
                column: "WorkerId");
