...
namespace JobListing.Migrations
{
    ...
    [Migration("20220311100156_WorkerUpdate2")]
    partial class WorkerUpdate2
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("JobListing.Models.Education", b =>
                {
                    ...
                    b.Property<bool>("CourseOrElse")
                        .HasColumnType("bit");

                    b.Property<bool>("HighSchool")
                        .HasColumnType("bit");

                    b.Property<bool>("Komvux")
                        .HasColumnType("bit");

                    b.Property<bool>("PeopleHighSchool")
                        .HasColumnType("bit");

                    b.Property<bool>("Polytechnic")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("JobListing.Models.Worker", b =>
                {
                    ...
                    b.Property<int?>("FileOneId")
                        .HasColumnType("int");

                    b.Property<int?>("FileThreeId")
                        .HasColumnType("int");

                    b.Property<int?>("FileTwoId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("FileOneId");

                    b.HasIndex("FileThreeId");

                    b.HasIndex("FileTwoId");
            ...
            modelBuilder.Entity("JobListing.Models.Worker", b =>
                {
                    b.HasOne("JobListing.Models.Category", "Branch")
                        .WithMany("Workers")
                    ...
                    b.HasOne("JobListing.Models.Files", "FileOne")
                        .WithMany()
                        .HasForeignKey("FileOneId");

                    b.HasOne("JobListing.Models.Files", "FileThree")
                        .WithMany()
                        .HasForeignKey("FileThreeId");

                    b.HasOne("JobListing.Models.Files", "FileTwo")
                        .WithMany()
                        .HasForeignKey("FileTwoId");
                    ...
                    b.Navigation("FileOne");

                    b.Navigation("FileThree");

                    b.Navigation("FileTwo");
