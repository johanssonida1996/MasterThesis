...
namespace JobListing.Migrations
{
    ...
    [Migration("20220311123432_updatedataEducation")]
    partial class updatedataEducation
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("JobListing.Models.Worker", b =>
                {
                    b.HasOne("JobListing.Models.Category", null)
                        .WithMany("Workers")
                        .HasForeignKey("CategoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("JobListing.Models.City", null)
                        .WithMany("Workers")
